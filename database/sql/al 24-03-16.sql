...
--
-- Servidor: localhost
-- Tiempo de generación: 24-03-2016 a las 19:08:42
...
CREATE TABLE IF NOT EXISTS `banco` (
  ...
  `nrocuenta` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `tipocuenta` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `banco_nombre_unique` (`nombre`)
...
INSERT INTO `configuracion` (`id`, `estatus`, `titulo`, `mensaje`, `urlimg`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'Disculpe...', 'Pagina en Mantenimiento', 'https://', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(2, 1, 'kñlkñlklñklñlñ', 'kñlkñlkñlkñlkñlkñ', 'kñkñlklññ', '2015-12-31 20:20:44', '2015-12-31 20:20:44', NULL);
...
CREATE TABLE IF NOT EXISTS `encomienda` (
  ...
  `urltracking` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `encomienda_nombre_unique` (`nombre`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3 ;
...
INSERT INTO `encomienda` (`id`, `nombre`, `observacion`, `urltracking`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Zoom', 'Disculpe...', 'http://', '0000-00-00 00:00:00', '2016-02-13 21:53:50', NULL),
(2, 'Mrw', 'Disculpe...', 'http://', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
...
CREATE TABLE IF NOT EXISTS `enviados` (
  ...
  `nroguia` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `enviados_ordenes_id_foreign` (`ordenes_id`)
...
INSERT INTO `enviados` (`id`, `ordenes_id`, `fecha`, `nroguia`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 6, '2016-03-22', '11111111111111111', '2016-03-23 02:29:54', '2016-03-23 02:29:54', NULL);
...
CREATE TABLE IF NOT EXISTS `gcm_users` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `gcm_users_name_unique` (`name`),
  UNIQUE KEY `gcm_users_email_unique` (`email`)
...
CREATE TABLE IF NOT EXISTS `inventario` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `codpro` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `descr` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `descr2` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `almacenamiento` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `grabacion` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `inventario_codpro_unique` (`codpro`)
...
INSERT INTO `inventario` (`id`, `codpro`, `descr`, `descr2`, `video`, `audio`, `resolucion`, `almacenamiento`, `grabacion`, `general`, `exist`, `oferta`, `precio`, `estatus`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'CAM1800-01', 'BULLET 1800TVL CMOS 36 LED (3M)', NULL, '', '', '', '', '', '', 10, 1, 20000.00, 0, '2016-03-02 18:51:49', '2016-03-23 10:20:04', NULL),
(2, 'CAM600-02', 'BULLET 600TVL CMOS 1/4 3.6mm 36LED (G:2)', NULL, '', '', '', '', '', '', 12, 0, 20130.00, 1, '2016-03-02 18:51:49', '2016-03-23 10:31:55', NULL),
(3, 'CAM600-03', 'BULLET 600TVL CMOS 1/4 3.6mm 36LED (G:2)', NULL, '', '', '', '', '', '', 15, 0, 18810.00, 1, '2016-03-02 18:51:49', '2016-03-02 18:51:49', NULL),
(4, 'CAM800-01-I', 'BULLET 800TVL HDIS 1/3 3.6MM 30LED (3M)', NULL, '', '', '', '', '', '', 23, 1, 24825.00, 1, '2016-03-02 18:51:49', '2016-03-16 12:46:08', NULL),
(5, 'CAM800-02-I', 'BULLET 800TVL CMOS 960h 48 LED (3M)', NULL, '', '', '', '', '', '', 19, 0, 32000.00, 1, '2016-03-02 18:51:49', '2016-03-02 18:51:49', NULL),
(6, 'CONDC-01-I', 'CONECTOR DC MACHO', NULL, '', '', '', '', '', '', 332, 1, 280.00, 1, '2016-03-02 18:51:49', '2016-03-02 18:51:49', NULL),
(7, 'CONDC-02', 'CONECTOR DC HEMBRA', NULL, '', '', '', '', '', '', 364, 1, 280.00, 1, '2016-03-02 18:51:49', '2016-03-02 18:51:49', NULL),
(8, 'DOMO1000-01-I', 'CAMARA DOMO 1/3 1000TVL 36LED 3.6MM CMOS', NULL, '', '', '962x504', '', '', '', 31, 0, 20130.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(9, 'DOMO1000-02', 'CAMARA DOMO 1/3 1000TVL 36LED 3.6MM SONY', NULL, '', '', '962x504', '', '', '', 20, 1, 22130.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(10, 'DOMO480-01', 'CAMARA DOMO 1/4 480TVL 3.6mm 24LED CMOS', NULL, '', '', '', '', '', '', 10, 1, 10000.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(11, 'DOMO600-01', 'CAMARA DOMO 1/4 600TVL 24LED 3.6MM CMOS', NULL, '', '', '', '', '', '', 20, 0, 14080.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(12, 'DOMO700-01-I', 'DOMO ANTIVANDALICA 700TVL HDIS 24LED G:3', NULL, '', '', '756x504', '', '', '', 61, 0, 16950.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(13, 'DVR-16CH-01-I', 'DVR 16 CANALES 960hx16 (G:3M)', NULL, 'VGA/BNC', '16', '1024x768', 'H.264 Ethenet 100/1000mbps', 'Soporta HD 4TB (max 2tb HDx2)', '960hx16', 1, 0, 98500.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(14, 'DVR-16CH-02-I', 'DVR 16 CANALES iCloud Graba en CIFx14', NULL, 'HDMI/VGA/BNC', '4', '1024x768', 'H.264', 'Soporta HD 1TB (max 2TB HD)', 'D1x2 - CIFx14', 4, 0, 88000.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(15, 'DVR-16CH-03', 'DVR 16 CANALES D1x2 CIFx14 (G:3M)', NULL, 'HDMI/VGA/BNC', '4', '1024x768', 'H264 - RS845 - CONTROL REMOTO', 'Soporta HD 1TB (max 2TB HD)', 'D1x2 - CIFx14', 4, 1, 85800.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(16, 'DVR-4CH-01', 'DVR 4 CANALES Graba en D1 (G:3M)', NULL, 'HDMI/VGA/BNC', '4', '1024x768', 'H.264 - RS485 - CONTROL REMOTO', 'Soporta HD 2TB (1TB/1TB)', '4 x D1', 4, 1, 63700.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(17, 'DVR-4CH-03-I', 'DVR 4 CANALES iCloud Graba en D1 (G:3M)', NULL, '', '1', '', 'H.264', 'Soporta HD 2TB (1TB/1TB)', 'D1x4', 1, 0, 47770.00, 0, '2016-03-02 18:51:50', '2016-03-02 18:55:00', NULL),
(18, 'DVR-8CH-02-I', 'DVR 8 CANALES HDL-960H Graba en HDL(G:3)', NULL, 'HDMI/VGA/BNC', '8', '1280x1024', 'H.264', 'Soporta DD 1TB (max 2TB)', '', 9, 0, 75000.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(19, 'DVR-8CH-03', 'DVR 8 CANALES Graba en CIF (G:3m)', NULL, 'HDMI/VGA/BNC', '8', '1024x768', 'H.264 PUERTO 485', '', '', 7, 1, 68500.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(20, 'RFID-01', 'TARJETA DE APROXIMIDAD RFID', NULL, '', '', '', '', '', '', 200, 1, 825.00, 1, '2016-03-02 18:51:50', '2016-03-02 18:51:50', NULL),
(21, 'TRA12V05A-01', 'TRANSFORMADOR 12v 0,5ma (G:0)-G', NULL, '', '', '', '', '', '', 18, 0, 2000.00, 1, '2016-03-02 18:51:50', '2016-03-08 06:35:08', NULL),
(22, 'TRA12V15-01-I', 'TRANSFORMADORES 12v 1,5A (G:0)', NULL, '', '', '', '', '', '', 124, 1, 3110.00, 1, '2016-03-02 18:51:51', '2016-03-02 18:51:51', NULL),
(23, 'TRA12V1A-01', 'TRANSFORMADORES 12v 1A (G:0)', NULL, '', '', '', '', '', '', 165, 1, 2450.00, 1, '2016-03-02 18:51:51', '2016-03-08 06:34:06', NULL),
(24, 'TRA12V2A-01-I', 'TRANSFORMADORES 12v 2A (G:0)-G', NULL, '', '', '', '', '', '', 44, 1, 4090.00, 1, '2016-03-02 18:51:51', '2016-03-02 18:51:51', NULL),
(25, 'TRA12V2A-02', 'TRANSFORMADORES 12v 2A (G:0)-P', NULL, '', '', '', '', '', '', 49, 1, 3850.00, 1, '2016-03-02 18:51:51', '2016-03-02 18:51:51', NULL),
(26, 'UTP-01', 'BOBINA DE CABLE UTP NIVEL 5E 305MTRS', NULL, '', '', '', '', '', '', 9, 0, 40500.00, 1, '2016-03-02 18:51:51', '2016-03-02 18:51:51', NULL),
(27, 'VB1CH-03', 'VIDEO BALUM 1CH CON CABLE (G:0)', NULL, '', '', '', '', '', '', 165, 0, 2080.00, 1, '2016-03-02 18:51:51', '2016-03-08 06:37:12', NULL),
(28, 'VB1CH-03-I', 'VIDEO BALUM 1CH (G:0)', NULL, '', '', '', '', '', '', 278, 1, 1980.00, 1, '2016-03-02 18:51:51', '2016-03-08 06:36:46', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `inv_imag`
--

CREATE TABLE IF NOT EXISTS `inv_imag` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `inventario_id` int(10) unsigned NOT NULL,
  `codpro` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `urlimagen` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `inv_imag_codpro_unique` (`codpro`),
  KEY `inv_imag_inventario_id_foreign` (`inventario_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=37 ;

--
-- Volcado de datos para la tabla `inv_imag`
--

INSERT INTO `inv_imag` (`id`, `inventario_id`, `codpro`, `urlimagen`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'CAM600-02', 'http://www.seguridadsistema.com.ve/app/imagenes/bullet700_1.png', '2016-01-30 02:34:44', '2016-01-30 02:34:44', NULL),
(2, 2, 'CAM600-03', 'http://www.seguridadsistema.com.ve/app/imagenes/camara.jpeg', '2016-01-30 02:34:44', '2016-01-30 02:34:44', NULL),
(3, 1, 'CAM700-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/bullet800.png', '2016-01-30 02:34:44', '2016-01-30 02:34:44', NULL),
(4, 3, 'CAM800-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/bullet800.png', '2016-01-30 02:34:44', '2016-01-30 02:34:44', NULL),
(5, 4, 'CAM800-02-I', 'http://www.seguridadsistema.com.ve/app/imagenes/bullet700.png', '2016-01-30 02:34:44', '2016-01-30 02:34:44', NULL),
(6, 5, 'CONDC-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/DcCordMacho.jpeg', '2016-01-30 02:34:45', '2016-01-30 02:34:45', NULL),
(7, 6, 'CONDC-02', 'http://www.seguridadsistema.com.ve/app/imagenes/DcCordHembra.png', '2016-01-30 02:34:45', '2016-01-30 02:34:45', NULL),
(8, 7, 'DD250-01', 'http://www.seguridadsistema.com.ve/app/imagenes/DD.jpeg', '2016-01-30 02:34:45', '2016-01-30 02:34:45', NULL),
(9, 8, 'DD500-01', 'http://www.seguridadsistema.com.ve/app/imagenes/DD.jpeg', '2016-01-30 02:34:45', '2016-01-30 02:34:45', NULL),
(10, 9, 'DOMO1000-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/domo1000.jpg', '2016-01-30 02:34:45', '2016-01-30 02:34:45', NULL),
(11, 10, 'DOMO1000-02', 'http://www.seguridadsistema.com.ve/app/imagenes/domo1000.jpg', '2016-01-30 02:34:46', '2016-01-30 02:34:46', NULL),
(12, 11, 'DOMO480-01', 'http://www.seguridadsistema.com.ve/app/imagenes/domo3.jpeg', '2016-01-30 02:34:46', '2016-01-30 02:34:46', NULL),
(13, 12, 'DOMO600-01', 'http://www.seguridadsistema.com.ve/app/imagenes/domo3.jpeg', '2016-01-30 02:34:46', '2016-01-30 02:34:46', NULL),
(14, 13, 'DOMO700-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/domo.jpeg', '2016-01-30 02:34:46', '2016-01-30 02:34:46', NULL),
(15, 14, 'DVR-16CH-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/dvr.png', '2016-01-30 02:34:47', '2016-01-30 02:34:47', NULL),
(16, 15, 'DVR-16CH-02-I', 'http://www.seguridadsistema.com.ve/app/imagenes/dvr.png', '2016-01-30 02:34:47', '2016-01-30 02:34:47', NULL),
(17, 16, 'DVR-4CH-03-I', 'http://www.seguridadsistema.com.ve/app/imagenes/DVR-CC.png', '2016-01-30 02:34:47', '2016-01-30 02:34:47', NULL),
(18, 1, 'DVR-8CH-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/Dvr2016.jpg', '2016-01-30 02:34:47', '2016-01-30 02:34:47', NULL),
(19, 17, 'DVR-8CH-02-I', 'http://www.seguridadsistema.com.ve/app/imagenes/dvr.png', '2016-01-30 02:34:47', '2016-01-30 02:34:47', NULL),
(20, 18, 'DVR-8CH-03', 'http://www.seguridadsistema.com.ve/app/imagenes/dvr.png', '2016-01-30 02:34:48', '2016-01-30 02:34:48', NULL),
(21, 19, 'FUENTE600', '1', '2016-01-30 02:34:48', '2016-01-30 02:34:48', NULL),
(22, 20, 'RFID-01', 'http://www.seguridadsistema.com.ve/app/imagenes/rfid.jpg', '2016-01-30 02:34:48', '2016-01-30 02:34:48', NULL),
(23, 21, 'SPLIT-01', 'http://www.seguridadsistema.com.ve/app/imagenes/split.png', '2016-01-30 02:34:48', '2016-01-30 02:34:48', NULL),
(24, 22, 'TRA12V05A-01', 'http://www.seguridadsistema.com.ve/app/imagenes/transformador.jpg', '2016-01-30 02:34:48', '2016-01-30 02:34:48', NULL),
(25, 23, 'TRA12V15-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/transformador.jpg', '2016-01-30 02:34:48', '2016-01-30 02:34:48', NULL),
(26, 24, 'TRA12V1A-01', 'http://www.seguridadsistema.com.ve/app/imagenes/transformador12a1.jpg', '2016-01-30 02:34:48', '2016-01-30 02:34:48', NULL),
(27, 25, 'TRA12V2A-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/transformadorv2a-G.jpeg', '2016-01-30 02:34:49', '2016-01-30 02:34:49', NULL),
(28, 26, 'TRA12V2A-02', 'http://www.seguridadsistema.com.ve/app/imagenes/transformadorv2.jpeg', '2016-01-30 02:34:49', '2016-01-30 02:34:49', NULL),
(29, 27, 'UTC-01-I', 'http://www.seguridadsistema.com.ve/app/imagenes/utc.jpg', '2016-01-30 02:34:49', '2016-01-30 02:34:49', NULL),
(30, 28, 'UTP-01', 'http://www.seguridadsistema.com.ve/app/imagenes/bobina.jpg', '2016-01-30 02:34:49', '2016-01-30 02:34:49', NULL),
(31, 29, 'VB1CH-03', 'http://www.seguridadsistema.com.ve/app/imagenes/VideoBalum.jpeg', '2016-01-30 02:34:49', '2016-01-30 02:34:49', NULL),
(32, 30, 'VB1CH-03-I', 'http://www.seguridadsistema.com.ve/app/imagenes/VideoBalum2.jpeg', '2016-01-30 02:34:49', '2016-01-30 02:34:49', NULL),
(33, 1, 'VB1CH-04', 'http://www.seguridadsistema.com.ve/app/imagenes/VideobalumActivo.jpg', '2016-01-30 02:34:49', '2016-01-30 02:34:49', NULL),
(34, 1, 'VB1CH-05', 'http://www.seguridadsistema.com.ve/app/imagenes/VideobalumActivo.jpg', '2016-01-30 02:34:50', '2016-01-30 02:34:50', NULL),
(35, 30, 'DVR-16CH-03', 'http://www.seguridadsistema.com.ve/app/imagenes/Dvr2016.jpg', '2016-02-16 20:07:05', '2016-02-16 20:07:05', NULL),
(36, 16, 'DVR-4CH-01', 'http://www.seguridadsistema.com.ve/app/imagenes/DVR-CC.png', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
...
('2015_10_11_043053_create_configuracion', 1),
('2015_10_11_045134_create_pago', 1),
('2015_10_11_045225_create_inventario', 1),
('2015_11_18_031230_create_encomiendas', 1),
('2015_11_18_031919_create_tipopagos', 1),
('2015_11_18_032215_create_bancos', 1),
('2015_11_18_042325_create_gcm_users', 1),
('2015_12_07_022729_create_inv_imag', 1),
('2015_12_11_163119_create_estados', 1),
('2015_12_11_171609_add_ordenes', 1),
('2015_12_12_000506_add_provicional_delete', 1),
('2015_12_24_215733_create_enviados', 2),
('2016_03_20_054031_update_ordene_table', 3);
...
CREATE TABLE IF NOT EXISTS `ordenes` (
  ...
  `seudonimo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `correo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cantidad` int(11) NOT NULL,
  `inventario_id` int(10) unsigned NOT NULL,
  `tipopago_id` int(10) unsigned NOT NULL,
  `bancorigen` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `banco_id` int(10) unsigned NOT NULL,
  `fecha` date NOT NULL,
  `monto` int(11) NOT NULL,
  `obser` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `envnombre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `envcedula` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `envtele` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `encomienda_id` int(10) unsigned NOT NULL,
  `envdirec` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `estado_id` int(10) unsigned NOT NULL,
  `ciudad_id` int(10) unsigned NOT NULL,
  `envobser` text COLLATE utf8_unicode_ci NOT NULL,
  `seguro` tinyint(1) NOT NULL DEFAULT '1',
  `estatus` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Por Enviar',
  `suscribir` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ordenes_inventario_id_foreign` (`inventario_id`),
  KEY `ordenes_banco_id_foreign` (`banco_id`),
  KEY `ordenes_encomienda_id_foreign` (`encomienda_id`),
  KEY `ordenes_estado_id_foreign` (`estado_id`),
  KEY `ordenes_ciudad_id_foreign` (`ciudad_id`)
...
INSERT INTO `ordenes` (`id`, `nombre`, `apellido`, `seudonimo`, `correo`, `cantidad`, `inventario_id`, `tipopago_id`, `bancorigen`, `banco_id`, `fecha`, `monto`, `obser`, `envnombre`, `envcedula`, `envtele`, `encomienda_id`, `envdirec`, `estado_id`, `ciudad_id`, `envobser`, `seguro`, `estatus`, `suscribir`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 3, 5, 2, 'venezuela', 6, '2015-01-01', 7120304, 'pppp', 'JESUS ESCOBAR', '', '0412', 2, '', 12, 122, '', 1, 'Por Enviar', 1, '2016-03-04 17:20:35', '2016-03-07 09:15:46', '2016-03-07 09:15:46'),
(2, 'LOBATON', 'LOBATON', 'seguridadsistema', 'jesuslobaton@gmail.com', 5, 26, 2, 'venezuela', 5, '2016-01-01', 250000, '', 'JESUS LOBATON', '', '0251', 1, '2250 NW 114TH AVE UNIT 1V', 12, 214, '', 1, 'Enviado', 1, '2016-03-07 07:49:22', '2016-03-07 07:54:49', NULL),
(3, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 6, 26, 2, 'venezuela', 5, '2015-01-01', 6, '', 'JESUS ESCOBAR', '', '0412', 1, '', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-07 09:48:57', '2016-03-07 10:06:47', '2016-03-07 10:06:47'),
(4, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 5, 26, 2, 'venezuela', 6, '2015-01-01', 123004, 'ppp', 'JESUS ESCOBAR', '', '0412', 1, '', 1, 4, '', 1, 'Por Enviar', 1, '2016-03-09 02:25:03', '2016-03-10 05:51:27', '2016-03-10 05:51:27'),
(5, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 6, 26, 2, 'venezuela', 6, '2015-01-01', 10000, 'ssss', 'JESUS ESCOBAR', '', '0412', 1, '06364 Maia DamNew Jaylin, GA 98921-9657', 1, 382, '', 1, 'Enviado', 1, '2016-03-10 06:26:44', '2016-03-17 03:50:30', NULL),
(6, 'kkkmm', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 7, 1, 2, 'venezuela', 5, '2014-01-01', 1, 'slañws', 'JESUS ESCOBAR', '15668694', '0412', 1, '06364 Maia DamNew Jaylin, GA 98921-9657', 2, 382, '', 1, 'Enviado', 1, '2016-03-11 04:00:18', '2016-03-23 02:29:54', NULL),
(7, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 2, 26, 2, 'venezuela', 6, '2016-03-29', 77, '', 'JESUS ESCOBAR', '15668694', '0412', 1, '06364 Maia DamNew Jaylin, GA 98921-9657', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-17 03:48:28', '2016-03-23 08:21:09', NULL),
(8, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 2, 26, 2, 'venezuela', 6, '2016-03-29', 7765, '', 'JESUS ESCOBAR', '15668694', '0412', 1, '06364 Maia DamNew Jaylin, GA 98921-9657', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-17 03:48:55', '2016-03-17 03:53:55', '2016-03-17 03:53:55'),
(9, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 6, 26, 2, 'venezuela', 5, '2016-03-21', 878767, 'kkk', 'JESUS ESCOBAR', '15668694', '0412', 1, 'kk', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-20 10:35:29', '2016-03-23 08:25:03', NULL),
(10, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 6, 26, 2, 'venezuela', 5, '2016-03-21', 86654, 'kkk', 'JESUS ESCOBAR', '15668694', '0412', 1, 'kk', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-20 10:36:42', '2016-03-20 10:36:42', NULL),
(11, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 6, 26, 2, 'venezuela', 5, '2016-03-21', 5579, 'kkk', 'JESUS ESCOBAR', '15668694', '0412', 1, 'kk', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-20 10:37:31', '2016-03-20 10:37:31', NULL),
(12, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 6, 26, 2, 'venezuela', 5, '2016-03-21', 2000, 'kkk', 'JESUS ESCOBAR', '15668694', '0412', 1, 'kk', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-20 10:38:31', '2016-03-20 10:38:31', NULL),
(13, 'JESUS MARIA', 'LOBATON ESCOBAR', 'SEGURIDADSISTEMA', 'jesuslobaton@gmail.com', 6, 26, 2, 'venezuela', 5, '2016-03-21', 1000, 'kkk', 'JESUS ESCOBAR', '15668694', '0412', 1, 'kk', 1, 382, '', 1, 'Por Enviar', 1, '2016-03-20 10:38:44', '2016-03-20 10:38:44', NULL);
...
CREATE TABLE IF NOT EXISTS `tipopago` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tipopago_nombre_unique` (`nombre`)
...
INSERT INTO `tipopago` (`id`, `nombre`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Transferencia', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(2, 'Deposito', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(3, 'Mercado Pago', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `tipo` enum('admin','usuario') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'usuario',
...
ALTER TABLE `enviados`
  ADD CONSTRAINT `enviados_ordenes_id_foreign` FOREIGN KEY (`ordenes_id`) REFERENCES `ordenes` (`id`);

--
-- Filtros para la tabla `inv_imag`
--
ALTER TABLE `inv_imag`
  ADD CONSTRAINT `inv_imag_inventario_id_foreign` FOREIGN KEY (`inventario_id`) REFERENCES `inventario` (`id`);

--
-- Filtros para la tabla `ordenes`
--
ALTER TABLE `ordenes`
  ADD CONSTRAINT `ordenes_banco_id_foreign` FOREIGN KEY (`banco_id`) REFERENCES `banco` (`id`),
  ADD CONSTRAINT `ordenes_ciudad_id_foreign` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`),
  ADD CONSTRAINT `ordenes_encomienda_id_foreign` FOREIGN KEY (`encomienda_id`) REFERENCES `encomienda` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `ordenes_estado_id_foreign` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`id`),
  ADD CONSTRAINT `ordenes_inventario_id_foreign` FOREIGN KEY (`inventario_id`) REFERENCES `inventario` (`id`);
